...
from models.fid import calculate_fid
...
if __name__ == "__main__":
    ...
    for i, data in enumerate(dataset):
        ...
        real_imgs.append(tensor2im(next(filter(lambda d: d[0] == "real_B", visuals.items()))[1]))
        fake_imgs.append(tensor2im(next(filter(lambda d: d[0] == "fake_B", visuals.items()))[1]))

    webpage.save()  # save the HTML

    print(calculate_fid([real_imgs, fake_imgs], 50, opt.device, 2048))
